        ...
        <div className="bg-white rounded-xl shadow-md p-8 prose prose-lg max-w-none">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-8">
            <p className="text-blue-900">
              <strong>What is a DPA?</strong><br/>
              A Data Processing Agreement is a legally binding contract between a data controller (you, the customer) and a data processor (OASIS BI PRO) that governs the processing of personal data in compliance with GDPR and Indonesian data protection laws.
            </p>
          </div>
          ...
          <ul>
            ...
            <li><strong>"Processor"</strong> means OASIS BI PRO, who processes Personal Data on behalf of the Controller</li>
            <li><strong>"Personal Data"</strong> means any information relating to an identified or identifiable natural person</li>
            <li><strong>"Processing"</strong> means any operation performed on Personal Data (collection, recording, storage, retrieval, use, disclosure, erasure, destruction)</li>
            <li><strong>"Sub-processor"</strong> means third parties engaged by OASIS BI PRO to assist in providing the Services</li>
            <li><strong>"Data Subject"</strong> means the individual whose Personal Data is being processed</li>
            <li><strong>"Data Protection Laws"</strong> means GDPR, Indonesian Law No. 27/2022, and other applicable regulations</li>
          </ul>

          <h2>2. Scope and Roles</h2>
          <h3>2.1 Relationship</h3>
          <p>
            You (the Customer) are the <strong>Data Controller</strong>, and OASIS BI PRO acts as the <strong>Data Processor</strong>. We process Personal Data solely on your behalf and according to your documented instructions.
          </p>

          <h3>2.2 Nature and Purpose of Processing</h3>
          <ul>
            <li><strong>Nature:</strong> Automated processing of business analytics data, user metrics, and transaction records</li>
            <li><strong>Purpose:</strong> To provide business intelligence, analytics, and reporting services as described in our Terms of Service</li>
            <li><strong>Duration:</strong> Throughout the term of the subscription and retention period defined in our Privacy Policy</li>
            <li><strong>Types of Personal Data:</strong> Names, email addresses, IP addresses, usage data, business metrics, transaction data</li>
            <li><strong>Categories of Data Subjects:</strong> Your employees, customers, and end-users whose data you input into our platform</li>
          </ul>

          <h2>3. Processor Obligations</h2>
          <p>OASIS BI PRO agrees to:</p>
          
          <h3>3.1 Processing Instructions</h3>
          <ul>
            <li>Process Personal Data only on your documented instructions (via our platform interface, API, or support requests)</li>
          ...
          <ul>
            ...
            <li><strong>Access Control:</strong> Role-Based Access Control (RBAC) with Multi-Factor Authentication (MFA)</li>
            <li><strong>Network Security:</strong> Firewalls, intrusion detection/prevention systems (IDS/IPS)</li>
            <li><strong>Monitoring:</strong> 24/7 security monitoring and incident response</li>
            <li><strong>Backups:</strong> Automated daily backups with encryption and geo-redundancy</li>
            <li><strong>Vulnerability Management:</strong> Regular penetration testing and security audits</li>
            <li><strong>Incident Response:</strong> Documented incident response procedures and 24h notification</li>
          </ul>
          ...
          <p>
            We will notify you of any changes to sub-processors at least 30 days in advance via email. You have the right to object to any new sub-processor within 14 days.
          </p>
          ...
          <ul>
            ...
            <li><strong>Right to Restriction:</strong> Restrict processing under certain conditions</li>
            <li><strong>Right to Data Portability:</strong> Export data in structured, machine-readable format (JSON, CSV)</li>
          ...
          <h3>3.6 Data Breach Notification</h3>
          ...
          <h3>3.7 Data Protection Impact Assessment (DPIA)</h3>
          <p>
            We will provide reasonable assistance in conducting DPIAs when required under Data Protection Laws, including:
          </p>
          <ul>
          ...
          <h3>3.8 Audits and Inspections</h3>
          <p>
          ...
          <ul>
            ...
            <li>Not provide us with sensitive personal data (health, biometric, racial/ethnic origin) without prior written agreement</li>
          ...
          <ul>
            <li><strong>Standard Contractual Clauses (SCCs):</strong> Approved by European Commission</li>
            <li><strong>Adequacy Decisions:</strong> Transfer only to countries with adequate data protection</li>
            <li><strong>Data Processing Agreements:</strong> With all sub-processors</li>
            <li><strong>Technical Measures:</strong> Encryption for all data in transit and at rest</li>
          </ul>

          <h2>6. Data Retention and Deletion</h2>
          <h3>6.1 Retention Periods</h3>
          <ul>
            <li><strong>Active Subscription:</strong> Data retained as long as account is active</li>
            <li><strong>After Cancellation:</strong> 30-day grace period, then permanent deletion</li>
            <li><strong>Backup Copies:</strong> Deleted within 90 days after account termination</li>
            <li><strong>Legal Retention:</strong> Transaction records retained for 7 years (tax/accounting requirements)</li>
          </ul>

          <h3>6.2 Data Return and Deletion</h3>
          ...
          <p>
            Our total liability under this DPA is limited to the amount paid by you in the 12 months preceding the claim, except for:
          </p>
          <ul>
          ...
          <p>
            We will indemnify you against claims, fines, and penalties resulting from our breach of this DPA, provided you:
          </p>
          <ul>
          ...
          <ul>
            <li><strong>Term:</strong> This DPA is effective from your first use of our Services and continues throughout your subscription</li>
            <li><strong>Termination:</strong> Automatically terminates upon end of subscription</li>
            <li><strong>Survival:</strong> Sections regarding data deletion, confidentiality, and liability survive termination</li>
          </ul>

          <h2>9. Governing Law and Dispute Resolution</h2>
          <ul>
            <li><strong>Governing Law:</strong> This DPA is governed by Indonesian law</li>
            <li><strong>Jurisdiction:</strong> Courts of Jakarta, Indonesia</li>
            <li><strong>Dispute Resolution:</strong> Good faith negotiation → mediation → arbitration → litigation</li>
            <li><strong>Data Protection Authority:</strong> Complaints may be filed with Indonesian Data Protection Authority or your local DPA</li>
          </ul>

          <h2>10. Amendments</h2>
          <p>
            We may update this DPA to reflect changes in Data Protection Laws or our processing activities. Material changes will be notified via:
          </p>
          <ul>
          ...
          <ul>
            <li><strong>Data Protection Officer:</strong> dpo@oasisbipro.com</li>
            <li><strong>Privacy Team:</strong> privacy@oasisbipro.com</li>
          ...
          <div className="bg-green-50 border-l-4 border-green-500 p-6 mt-8">
            <p className="text-green-900">
              <strong>✅ GDPR & Indonesian Law Compliant</strong><br/>
              This DPA complies with Article 28 of GDPR, Indonesian Law No. 27/2022 on Personal Data Protection, and international data protection standards. It provides the necessary contractual safeguards for data processing relationships.
            </p>
          </div>

          <p className="mt-8 pt-8 border-t border-gray-200 text-gray-600">
            <strong>Download:</strong> <Link href="/legal/dpa" className="text-primary-600 hover:underline">Download DPA as PDF</Link><br/>
            <strong>Effective Date:</strong> November 15, 2025<br/>
