        ...
        <div className="bg-white rounded-xl shadow-md p-8 prose prose-lg max-w-none">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-8">
            <p className="text-blue-900">
              ...
              Cookies are small text files stored on your device (computer, tablet, mobile phone) when you visit a website. They help websites remember your preferences, improve user experience, and provide analytics insights.
            </p>
          </div>

          <h2>1. Introduction</h2>
          <p>
            This Cookie Policy explains how OASIS BI PRO ("we," "our," or "us") uses cookies and similar technologies on our website and platform. By using our services, you consent to the use of cookies as described in this policy.
          </p>
          ...
          <table className="min-w-full divide-y divide-gray-200 my-6">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              <tr>
                ...
                <td className="px-6 py-4 text-sm text-gray-600">Security - prevents Cross-Site Request Forgery attacks</td>
          ...
          <p>
            These cookies help us understand how visitors use our website, which pages are most popular, and how we can improve user experience.
          </p>
          <table className="min-w-full divide-y divide-gray-200 my-6">
            <thead className="bg-gray-50">
              <tr>
          ...
          <table className="min-w-full divide-y divide-gray-200 my-6">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              <tr>
                ...
                <td className="px-6 py-4 text-sm text-gray-600">Facebook Pixel - tracks conversions from Facebook ads</td>
          ...
          <ul>
            ...
            <li><strong>Vercel Analytics:</strong> Performance monitoring and real-user metrics</li>
            <li><strong>Supabase:</strong> Authentication and database services</li>
            <li><strong>Midtrans:</strong> Payment processing (only on payment pages)</li>
            <li><strong>Facebook Pixel:</strong> Ad tracking and conversion measurement (with consent)</li>
          </ul>
          ...
          <ul>
            <li><strong>Accept All:</strong> Allow all cookies (essential, preference, analytics, marketing)</li>
            <li><strong>Reject Non-Essential:</strong> Only essential cookies will be used</li>
            <li><strong>Customize Settings:</strong> Choose which categories of cookies to allow</li>
          </ul>
          ...
          <ul>
            <li><strong>Google Analytics:</strong> <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:underline">Google Analytics Opt-out Browser Add-on</a></li>
            <li><strong>Facebook:</strong> <a href="https://www.facebook.com/ads/preferences" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:underline">Facebook Ad Preferences</a></li>
            <li><strong>General Advertising:</strong> <a href="http://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:underline">Digital Advertising Alliance Opt-Out</a></li>
          </ul>
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-500 p-6 my-6">
            ...
            <ul className="mt-3 space-y-2 text-yellow-800">
              <li>• <strong>Essential Cookies:</strong> Website may not function properly; you may not be able to log in</li>
          ...
          <h2>6. Cookie Duration Explained</h2>
          <ul>
            <li><strong>Session Cookies:</strong> Deleted when you close your browser</li>
            <li><strong>Persistent Cookies:</strong> Remain on your device for a specified period (e.g., 30 days, 1 year, 2 years)</li>
            <li><strong>First-Party Cookies:</strong> Set by OASIS BI PRO domain</li>
            <li><strong>Third-Party Cookies:</strong> Set by external services (Google, Facebook, etc.)</li>
          </ul>
          ...
          <p>
            If you use our mobile app, similar technologies are used:
          </p>
          <ul>
            <li><strong>Device Identifiers:</strong> Unique identifiers for analytics and authentication</li>
            <li><strong>Local Storage:</strong> Stores app preferences and cached data</li>
            <li><strong>Push Notification Tokens:</strong> Enables push notifications (with permission)</li>
          </ul>
          <p>
            You can control these through your device's app settings (iOS: Settings → Privacy; Android: Settings → Privacy → Permission Manager).
          </p>

          <h2>9. Children's Privacy</h2>
          <p>
            Our services are not directed to children under 18. We do not knowingly collect data from children. If you are a parent or guardian and believe your child has provided us with personal information, please contact us at privacy@oasisbipro.com.
          </p>
          ...
          <h2>11. Your Rights Under GDPR & Indonesian Law</h2>
          <p>
            Under GDPR and Indonesian Law No. 27/2022, you have the right to:
          </p>
          <ul>
            <li><strong>Withdraw Consent:</strong> Change your cookie preferences at any time</li>
            <li><strong>Access Your Data:</strong> Request information about cookies set on your device</li>
            <li><strong>Delete Your Data:</strong> Request deletion of data collected via cookies</li>
            <li><strong>Object to Processing:</strong> Object to use of cookies for specific purposes</li>
          </ul>
          ...
          <div className="bg-green-50 border-l-4 border-green-500 p-6 mt-8">
            <p className="text-green-900">
              ...
              This Cookie Policy complies with GDPR (ePrivacy Directive), Indonesian Law No. 27/2022, CCPA, and international best practices for cookie consent and transparency.
            </p>
          </div>

          <p className="mt-8 pt-8 border-t border-gray-200 text-gray-600">
            <strong>Manage Your Cookie Preferences:</strong> <button className="text-primary-600 hover:underline">Update Cookie Settings</button><br/>
